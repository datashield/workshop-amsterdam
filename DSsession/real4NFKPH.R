...
datashield.assign(opals, "BMI_NM",quote(replace.9.na(D$PM_BMI_CATEGORIAL)))
datashield.assign(opals, "DIS_CVA_NM",quote(replace.9.na(D$DIS_CVA)))
datashield.assign(opals, "MEDI_LPD_NM",quote(replace.9.na(D$MEDI_LPD)))
datashield.assign(opals, "DIS_DIAB_NM",quote(replace.9.na(D$DIS_DIAB)))
datashield.assign(opals, "DIS_AMI_NM",quote(replace.9.na(D$DIS_AMI)))
...
datashield.aggregate(opals, quote(mean.a.by.b(D$PM_BMI_CONTINUOUS,BMI_NM)))
...
glm.mod2<-datashield.glm(opals, D$LAB_GLUC_FASTING ~ BMI_NM, quote(gaussian),quote(20))
glm.mod2
...
glm.mod3<-datashield.glm(opals, D$LAB_GLUC_FASTING ~ BMI_NM, quote(gaussian),quote(20))
glm.mod3
...
glm.mod6<-datashield.glm(opals, DIS_DIAB_NM ~ sex.f+D$PM_BMI_CONTINUOUS+D$LAB_HDL, quote(binomial),quote(20))
glm.mod6

glm.mod7<-datashield.glm(opals, DIS_DIAB_NM ~ sex.f*D$PM_BMI_CONTINUOUS+D$LAB_HDL, quote(binomial),quote(20))
glm.mod7
...
glm.mod8<-datashield.glm(opals, MEDI_LPD_NM ~ sex.f*D$LAB_HDL+D$PM_BMI_CONTINUOUS+D$LAB_TSC, quote(binomial),quote(20))
glm.mod8
...
glm.mod9<-datashield.glm(opals, MEDI_LPD_NM ~ sex.f*HDL.1.5+D$PM_BMI_CONTINUOUS+D$LAB_TSC, quote(binomial),quote(20))
glm.mod9