...
a1 <- datashield.glm(opals, LAB_TSC ~ GENDER, quote(gaussian), quote(20))
summary(a1)


# Q2: DO PEOPLE WHO ARE OBESE HAVE HIGHER GLUCOSE LEVELS? (GLUCOSE LEVEL BY BMI CATEGORY)

GlobalAssign(opals, "LAB_GLUC_NONFASTING")
GlobalAssign(opals, "PM_BMI_CATEGORIAL")
a2 <- datashield.glm(opals, LAB_GLUC_NONFASTING ~ PM_BMI_CATEGORIAL, quote(gaussian), quote(20))
summary(a2)
...
a5 <- datashield.glm(opals, DIS_DIAB ~ LAB_GLUC_NONFASTING + PM_BMI_CONTINUOUS, quote(binomial), quote(20))
summary(a5)
